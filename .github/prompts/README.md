...
> **25 reusable prompt templates** extracted from vault skills for consistent, high-quality code generation.
...
**Covers:** tsconfig, package.json type:module, import extensions, \_\_dirname polyfill
...
### `npm/package-publishing.prompt.md`

Complete protocol for publishing packages to npm registry, from validation to post-publish verification.

**Covers:** Pre-publish checklist, dry-run validation, versioning strategy, common errors, scoped packages

**Use for:** Publishing CLI tools, libraries, or any npm package
